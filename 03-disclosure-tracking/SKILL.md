---
name: 03-disclosure-tracking
description: "Disclosure tracking. Use when TRID disclosure packages need assembly with per-figure sources and delivery-evidence trails - the licensed human reviews, signs, and sends, every time."
---

# Agent 03 - Disclosure Tracking Agent
...
Runs disclosure production support around the TRID clocks: assembles
...
{
  "envelope_id": "uuid",
  "from_agent": "03-disclosure-tracking",
