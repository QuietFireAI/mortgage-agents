...
description: "Daily operations. Use for the pipeline morning book, end-of-day books with missed-item sweep, and clock reconciliation - books inform, the human directs."
---
...
The pipeline's cadence: the morning book (new applications, today's
