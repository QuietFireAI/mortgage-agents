...
description: "Document collection. Use when borrower financial documents need checklist requests, inventory, cadenced chase, and anomaly FACTS - authenticity judgments are human, LOEs are borrower-authored (GLBA custody)."
---
...
Owns the borrower-document pipeline: paystubs, W-2s, tax returns, bank
