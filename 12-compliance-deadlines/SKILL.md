...
description: "Compliance and deadlines. Use when TRID, ECOA, and lock clocks need instantiation, conservative math, lead-time alerts, and waiting-period holds - clocks are facts."
---
...
Runs the clock engine: TRID disclosure clocks (LE three business days
